...
class AccountDepositWithdraw extends React.Component {
    ...
    render() {
      ...
      var avatar1 = require("assets/avatar1.png")
      var avatar2 = require("assets/avatar2.png")
      var avatar3 = require("assets/avatar3.png")
      var avatar4 = require("assets/avatar4.png")
      var avatar5 = require("assets/avatar5.png")
        return (
            <div className={this.props.contained ? "grid-content" : "grid-container"}>
                <h2 style={{paddingLeft: "20px"}}>BTSVIP第三方承兑商</h2>
                <div style={{float: "left", margin: "10px 20px", border: "1px solid rgb(187, 187, 187)", width: "300px", fontSize: "14px"}}>
                    <div style={{padding: "10px", fontSize: "14px"}}><img
                        src={avatar1} width="50px" height="50px"
                        style={{float: "left", width: "50px", height: "50px"}}/>
                        <div style={{float: "left", marginLeft: "25px", width: "200px"}}><div style={{display: "block"}}>西北矿主<span style={{float: "right", color: "red"}}>保证金60万元</span></div>
                ...
                <div style={{float: "left", margin: "10px 20px", border: "1px solid rgb(187, 187, 187)", width: "300px", fontSize: "14px"}}>
                    <div style={{padding: "10px", fontSize: "14px"}}><img
                        src={avatar2} width="50px" height="50px"
                        style={{float: "left", width: "50px", height: "50px"}}/>
                        <div style={{float: "left", marginLeft: "25px", width: "200px"}}><div style={{display: "block"}}>白菜<span style={{float: "right", color: "red"}}>保证金45万元</span></div>
                            <div style={{display: "block", marginTop: "7px"}}><img
                                src="data:image/jpg;base64,"
                                width="13px" height="13px" style={{float: "left"}}/><img
                                src="data:image/jpg;base64,"
                ...
                <div style={{float: "left", margin: "10px 20px", border: "1px solid rgb(187, 187, 187)", width: "300px", fontSize: "14px"}}>
                    <div style={{padding: "10px", fontSize: "14px"}}><img
                        src={avatar3} width="50px" height="50px"
                        style={{float: "left", width: "50px", height: "50px"}}/>
                        <div style={{float: "left", marginLeft: "25px", width: "200px"}}><div style={{display: "block"}}>嘿。你的益达！<span style={{float: "right", color: "red"}}>保证金30万元</span></div>
                            <div style={{display: "block", marginTop: "7px"}}><img
                                src="data:image/jpg;base64,"
                                width="13px" height="13px" style={{float: "left"}}/><img
                                src="data:image/jpg;base64,"
                ...
                <div style={{float: "left", margin: "10px 20px", border: "1px solid rgb(187, 187, 187)", width: "300px", fontSize: "14px"}}>
                    <div style={{padding: "10px", fontSize: "14px"}}><img
                        src={avatar4} width="50px" height="50px"
                        style={{float: "left", width: "50px", height: "50px"}}/>
                        <div style={{float: "left", marginLeft: "25px", width: "200px"}}><div style={{display: "block"}}>点点<span style={{float: "right", color: "red"}}>保证金20万元</span></div>
                            <div style={{display: "block", marginTop: "7px"}}><img
                                src="data:image/jpg;base64,"
                                width="13px" height="13px" style={{float: "left"}}/><img
                                src="data:image/jpg;base64,"
