    ...
    _renderAccountCreateForm() {
        ...
        return (
            <div style={{textAlign: "left"}}>
                ...
                <section>
                    <label className="left-label"><Translate content="wallet.generated" />&nbsp;&nbsp;<span className="tooltip" data-html={true} data-tip="密码是由你的浏览器在你当前的计算机上生成的，除了你以外，没有任何人能知道这个密码，请务必要复制下面的密码，然后拷贝到一个或几个安全的地方保存"><Icon name="question-circle" /></span></label>
